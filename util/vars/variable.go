...
// effect
var knownPrefixes = []VariablePrefix{VariablePrefixEnv, VariablePrefixDollarDot, VariablePrefixVColon, VariablePrefixGColon, VariablePrefixHColon, VariablePrefixDollarSquareBracket}
